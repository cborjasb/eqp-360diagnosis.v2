...
export const ScoreInput: React.FC<ScoreInputProps> = ({
  ...
  return (
    <div className="border border-gray-200 rounded-lg mb-3 overflow-hidden bg-white shadow-sm transition-all hover:shadow-md">
      ...
      {isOpen && (
        <div className="bg-gray-50 p-4 border-t border-gray-100 space-y-4 animate-slide-down">
          ...
          <div className="mt-2 p-2 bg-blue-50 text-blue-800 text-xs rounded-sm flex items-start gap-2">
